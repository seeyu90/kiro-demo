...
RSpec.describe ProjectRosterSheetsClient do
  ...
  it "reads the 專案清單 range and re-tags string cells as UTF-8" do
    ...
    row = [ "AG 亞炬".dup.force_encoding(Encoding::ASCII_8BIT), "亞炬 Platform" ]
    ...
    expect(result).to eq([ [ "AG 亞炬", "亞炬 Platform" ] ])
